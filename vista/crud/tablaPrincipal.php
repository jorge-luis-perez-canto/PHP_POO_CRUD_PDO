...
<div class="col-12 col-md-12"> 
    ...
    <div style="float:left; margin-bottom:5px;">
        <form action="" method="post">
            <input value="showFormInsertar" name="formulario" type="hidden"/>
                            ...
                            <td>
                                <center>
                                    <form method='POST' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
                                        <input value="showFormEditar" name="formulario" type="hidden"/>
                            ...
                            <td>
                                <center>
                                    <form  onsubmit="return confirm('Realmente desea eliminar el registro?');" method='POST' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
                                        <input type='hidden' name='id' value='<?php echo $item->id; ?>'/>
                                        <input value="showFormEliminar" name="formulario" type="hidden"/>
